...
writeRg2AverageToFile(result, "rg2AverageResults.csv", 2000, min_length=345, max_length=378)
writeTotalRgPerTimestep(result, "totalRgPerTimestep.csv", chain_length_range=(345, 378))